...
def test_extract_today_news():
    ...
    published_at = DateTime(2020, 10, 2, 9, 0, 0, 0, tzinfo=tzinfo)
    include_news_A = News(
        title=title,
        summary=summary,
        link=link,
    ...
    published_at = DateTime(2020, 10, 2, 7, 0, 0, 0, tzinfo=tzinfo)
    exclude_news_B = News(
        title=title,
        summary=summary,
        link=link,
    ...
    published_at = DateTime(2020, 10, 3, 7, 0, 0, 0, tzinfo=tzinfo)
    include_news_C = News(
        title=title,
        summary=summary,
        link=link,
    ...
    published_at = DateTime(2020, 10, 3, 9, 0, 0, 0, tzinfo=tzinfo)
    exclude_news_D = News(
        title=title,
        summary=summary,
        link=link,
